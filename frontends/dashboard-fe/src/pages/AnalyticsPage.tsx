  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Análise de Relatórios</h1>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-sm text-gray-600 font-semibold">Total de Relatórios</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-xs text-green-600 mt-2">↑ 23% esta semana</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-sm text-gray-600 font-semibold">Taxa de Atualização</p>
            <p className="text-3xl font-bold text-purple-600 mt-2">8.5%</p>
            <p className="text-xs text-red-600 mt-2">↓ 2% desde ontem</p>
          </div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Crescimento de Relatórios</h2>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={data}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="reports" stroke="#4f46e5" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={data}>
                ...
                <Bar dataKey="updates" fill="#8b5cf6" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
